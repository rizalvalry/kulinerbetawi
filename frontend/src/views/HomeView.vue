        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                ...
                >
                    ...
                    <h5 class="font-weight-semi-bold m-0">Rasa berKelas</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div
                ...
                >
                    ...
                    <h5 class="font-weight-semi-bold m-0">Ongkir Murah</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div
                ...
                >
                    ...
                    <h5 class="font-weight-semi-bold m-0">Fast & Pre Order</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div
                ...
                >
                    ...
                    <h5 class="font-weight-semi-bold m-0">Layanan 24Jam</h5>
                </div>
            </div>
        </div>
    </div>

                ...
                <div class="row border-top px-xl-5">
                    ...
                    <div class="col-lg-9">
                        ...
                        >
                            ...
                            <img class="img-fluid" src="http://127.0.0.1:8000/storage/img/17245710781.png" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Dibuat Dengan Penuh Cinta</h3>
